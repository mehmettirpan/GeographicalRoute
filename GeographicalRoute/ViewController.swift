...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    //        başlamadan önce diziyi sıfırladık yoksa bütün diziden bir daha kaydediyor
        ...
        @objc func clickedAddButton(){
            ...
            //        diğer tarafa g,derken boş bir string olarak gidecektir ve diğer taraf bunun boşlıktan geldiğini anlayacaktır. diğer taraf ise if chosenObjectName else kısmı
